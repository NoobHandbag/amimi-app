  ...
  return (
    <div
      style={{
        ...
        borderRadius: 12, padding: '10px 12px', marginTop: 18, color: 'var(--negative-ink)',
      }}
    >
      <button
      ...
      >
        ...
        <span style={{ marginLeft: 'auto', opacity: .8, display: 'inline-flex' }}><Icon name={open ? 'chevron-up' : 'chevron-down'} size={16} /></span>
      </button>
      {open && (
        <ul style={{ margin: '10px 0 2px', paddingLeft: 18, color: 'var(--ink)', fontSize: 13.5, lineHeight: 1.5 }}>
          {items.map((r) => (
