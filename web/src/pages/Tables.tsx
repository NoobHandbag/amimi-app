...
export const TABLES: TableCfg[] = [
  ...
  { key: 'acquisti', label: 'Arrivi / Acquisti', icon: 'box', desc: 'Pezzi arrivati / acquistati', source: 'purchases', order: { field: 'created_at' }, cols: [
  ...
  { key: 'vendite_negozio', label: 'Vendite negozio', icon: 'store', desc: 'Vendite Qromo (POS)', source: 'qromo_sales', order: { field: 'data' }, cols: [
  ...
  { key: 'vendite_online', label: 'Vendite online', icon: 'bag', desc: 'Ordini Shopify', source: 'shopify_orders', order: { field: 'created_at_shop' }, cols: [
  ...
  { key: 'b2b', label: 'Conto vendita B2B', icon: 'store', desc: 'Movimenti nei negozi', source: 'b2b_movements', order: { field: 'data' }, cols: [
