...
> Stato: **costruito, deployato, testato (5 casi) il 2026-06-29. IDLE** finché non si fa il cutover.
...
- **Auth:** Qromo manda un campo `auth` nel body; deve combaciare con `app_flags.qromo_webhook_secret` (ruotabile con una UPDATE su quella riga).
