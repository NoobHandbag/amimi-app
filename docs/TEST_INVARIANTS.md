...
| **Fatto (22-09, lead-outreach)** | `tests/lead_outreach_guardie.mjs` (53 asserzioni: blocco `PURE:lead-guard` ritagliato dal sorgente + regole su sorgente e migr 0139) | segnaposto rimasti, destinatario, opt-out, firma/opt-out garantiti, avvisi di contenuto (cotone/Italia, condizioni, allegati), giorno di Roma per il tetto, claim prima di Gmail, vincoli unici a DB, esito incerto e sblocco. Nella Gate 1 della skill dal 22-09 |
