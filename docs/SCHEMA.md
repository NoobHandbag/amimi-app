...
## 15. Modulo Meta Ads a livello creativita' (migr 0128-0131, 2026-09-18)
...
- **Gotcha**: `retailer_id` del catalogo Meta = variant id Shopify, e `shopify_stock.variant_id` tiene UNA variante per codice (dual SC/CC): la variante sorella cade sul fallback per nome. La `pct_oos` e' sui risolti, per questo il gate di copertura nell'azione.
